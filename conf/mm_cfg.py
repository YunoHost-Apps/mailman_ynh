...
DEFAULT_URL_PATTERN = 'https://%s__PATH_URL_SLASH_LESS___/'
IMAGE_LOGOS         = '__PATH_URL_SLASH_LESS___/images/'
SITE_LOGO           = '__PATH_URL_SLASH_LESS___/images/debianpowered.png'

#-------------------------------------------------------------
# Default domain for email addresses of newly created MLs
DEFAULT_EMAIL_HOST = '__DOMAIN__'
#-------------------------------------------------------------
# Default host for web interface of newly created MLs
DEFAULT_URL_HOST   = '__DOMAIN__'
#-------------------------------------------------------------
...
#-------------------------------------------------------------
# Path for archives
PUBLIC_ARCHIVE_URL = 'https://%(hostname)s__PATH_URL_SLASH_LESS___/archives/%(listname)s'

#-------------------------------------------------------------
# The default language for this server.
DEFAULT_SERVER_LANGUAGE = '__LANGUAGE__'
...
POSTFIX_STYLE_VIRTUAL_DOMAINS = [ '__DOMAIN__' ]
